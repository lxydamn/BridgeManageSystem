	...
	<a-skeleton :loading="loading" active>
		<div class="basic-card-container" v-if="!loading">
			<a-form layout="horizontal" class="basic-card-form">
				...
				<a-form-item>
					<table class="basic-card-table">
						...
						<tr>
							...
							<td class="table-item-content">
								<a-input placeholder="桥位桩号" disabled v-model:value="initCardData.data.bridge_pile" />
							</td>
						</tr>
						<tr>
							...
							<td class="table-item-content">
								<a-input placeholder="被跨越道路名称" disabled v-model:value="initCardData.data.cro_name" />
							</td>
							<td class="table-item-name">被跨越道路桩号</td>
							<td class="table-item-content">
								<a-input placeholder="被跨越道路桩号" disabled v-model:value="initCardData.data.cro_no" />
							</td>
						</tr>
						<tr>
							...
							<td class="table-item-content">
								<a-input-number class="input-item-default" suffix="°" pattern="[0-9]*" placeholder="桥梁坡度"
									v-model:value="cardInfo.arr.bridge_slope" />
							</td>
							<td class="table-item-name">桥梁平曲线半径</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" suffix="m" pattern="[0-9]*" placeholder="桥梁平曲线半径"
									v-model:value="cardInfo.arr.bridge_radius" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">建成时间</td>
							<td class="table-item-content">
								<a-date-picker value-format="YYYY-MM-DD" :locale="locale" class="input-item-default"
									format="YYYY-MM-DD" placeholder="建成时间" v-model:value="cardInfo.arr.build_time" />
							</td>
							<td class="table-item-name">设计单位</td>
							<td class="table-item-content">
								<a-input placeholder="设计单位" disabled v-model:value="initCardData.data.des_unit" />
							</td>
							<td class="table-item-name">施工单位</td>
							<td class="table-item-content">
								<a-input placeholder="施工单位" disabled v-model:value="initCardData.data.cst_unit" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">监理单位</td>
							<td class="table-item-content">
								<a-select class="input-item-default" v-model:value="cardInfo.units.spr_unit"
									:options="units" :field-names="{ label: 'unit_name', value: 'unit_no' }"></a-select>
							</td>
							<td class="table-item-name">业主单位</td>
							<td class="table-item-content">
								<a-select class="input-item-default" v-model:value="cardInfo.units.own_unit"
									:options="units" :field-names="{ label: 'unit_name', value: 'unit_no' }"></a-select>
							</td>
				...
				<a-form-item>
					<table class="basic-card-table">
						<tr>
							...
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="桥面总宽"
									v-model:value="techIndex.arr.bridge_wdh" />
							</td>
							<td class="table-item-name">车道宽度</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="车道宽度"
									v-model:value="techIndex.arr.car_wdh" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">人行道宽度</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="人行道宽度"
									v-model:value="techIndex.arr.psn_wdh" />
							</td>
							<td class="table-item-name">护栏或防撞墙高度</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="护栏或防撞墙高度"
									v-model:value="techIndex.arr.pet_hgt" />
							</td>
							<td class="table-item-name">中央分隔带高度</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="中央分隔带高度"
									v-model:value="techIndex.arr.ctr_dvr_wdh" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">桥面标准净空</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="桥面标准净空"
									v-model:value="techIndex.arr.std_hrm" />
							</td>
							<td class="table-item-name">桥面实际净空</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="桥面实际净空"
									v-model:value="techIndex.arr.act_hrm" />
							</td>
							<td class="table-item-name">桥下通航等级及标准净空</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="桥下通航等级及标准净空"
									v-model:value="techIndex.arr.std_trm" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">桥下实际净空</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="桥下实际净空"
									v-model:value="techIndex.arr.act_trm" />
							</td>
							<td class="table-item-name">引道总宽</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="引道总宽"
									v-model:value="techIndex.arr.apr_wdh" />
							</td>
							<td class="table-item-name">引道线形或曲线半径</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="引道线形或曲线半径"
									v-model:value="techIndex.arr.crv_rds" />
							</td>
						</tr>
						<tr>
							<td class="table-item-name">设计洪水频率及其水位</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="设计洪水频率及其水位"
									v-model:value="techIndex.arr.des_fol_lev" />
							</td>
							<td class="table-item-name">历史洪水位</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="历史洪水位"
									v-model:value="techIndex.arr.his_fol_lev" />
							</td>
							<td class="table-item-name">设计地震动峰值加速度系数</td>
							<td class="table-item-content">
								<a-input-number class="input-item-default" placeholder="设计地震动峰值加速度系数"
									v-model:value="techIndex.arr.grd_pek_acc" />
							</td>
						</tr>
					</table>
				</a-form-item>
				...
				<a-form-item>
					<div class="struct-container" v-if="bridgeStruct.arr.length != 0" v-for="item in bridgeStruct.arr">
						<a-row>
							<a-col :span="1" class="struct-main">
								<h4> {{ item.struct }} </h4>
							</a-col>
							<a-col :span="23">
				...
				<a-form-item>
					<table class="basic-card-table">
						<tr>
							...
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.des_draw" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">设计文件</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.des_file" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">竣工图纸</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.fin_draw" :options="options">
								</a-select>
							</td>
						</tr>
						<tr>
							...
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.cst_file" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">验收文件</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.acp_file" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">行政审批文件</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.adm_apv_file" :options="options">
								</a-select>
							</td>
						</tr>
						<tr>
							...
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.per_chk_info" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">特殊检查资料</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.spc_chk_info" :options="options">
								</a-select>
							</td>
							<td class="table-item-name">历次维修、加固资料</td>
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.hsy_info" :options="options">
								</a-select>
							</td>
						</tr>
						<tr>
							...
							<td class="table-item-content">
								<a-select v-model:value="bridgeFile.arr.ohr_info" :options="options">
								</a-select>
							</td>
							...
							<td class="table-item-content">
								<a-date-picker value-format="YYYY-MM-DD" format="YYYY-MM-DD" :locale="locale"
									placeholder="建档时间" class="input-item-default"
				...
				<a-form-item>
					...
					<div class="photo-box">
						<a-row justify="space-around" style="height: 100%; align-items: center">
							<a-col>
								<a-input placeholder="图片链接" v-model:value="cardInfo.arr.oal_photo" />
							</a-col>
							<a-col :span="6" class="img-input-box">
								<img :src="cardInfo.arr.oal_photo.length === 0 ? defaultImg : cardInfo.arr.oal_photo"
									alt="图片" />
							</a-col>
							<a-col>
								<a-input placeholder="图片链接" v-model:value="cardInfo.arr.frt_photo" />
							</a-col>
							<a-col :span="6" class="img-input-box">
								<img :src="cardInfo.arr.frt_photo.length === 0 ? defaultImg : cardInfo.arr.frt_photo"
									alt="图片" />
							</a-col>
						</a-row>
					</div>
					...
					<table class="basic-card-table">
						<tr style="border-bottom: 1px solid #6c6969">
							...
							<td class="table-item-content">
								<a-input placeholder="桥梁工程师" disabled v-model:value="initCardData.data.brid_engi" />
							</td>
							...
							<td class="table-item-content">
								<a-date-picker value-format="YYYY-MM-DD" format="YYYY-MM-DD" :locale="locale"
									class="input-item-default" placeholder="填卡日期" v-model:value="cardInfo.arr.card_time" />
							</td>
						</tr>
					</table>
				</a-form-item>
